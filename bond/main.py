...
plot_corporate = figure(plot_height=500, plot_width=1200, tools=tools, x_axis_type='datetime')
...
plot_repo = figure(plot_height=500, plot_width=1200, tools=tools, x_axis_type='datetime')
...
plot_cny = figure(plot_height=500, plot_width=1200, tools=tools, x_axis_type='datetime')
...
plot_product = figure(plot_height=500, plot_width=1200, tools=tools, x_axis_type='datetime')
